...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 9762ffd7124cb1d953c7607b8fc8a0ba) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Stellaris"];
                      lib_pack = false;
                      lib_internal_modules = ["Grammar"; "Ast"; "Condition"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving.std cmdliner", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "effecttrigger.ml"});
               Doc
                 ({
                     cs_name = "stellaris";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Stellaris";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Drup/stellaris.git";
                      src_repo_browser =
                        Some "https://github.com/Drup/stellaris";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\021\164\203*I\255\209\144\165\017ee\134\212'\139";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
