...
[@@@ocaml.warning "-3"]
(* OASIS_START *)
(* DO NOT EDIT (digest: 9841c1e6900d992943784c28ebddb4f9) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Grammar"; "Ast"; "Condition"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("re containers fmt cmdliner", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\142\139\132\156\218 \143\196Q\220\198T\197)\1999";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
